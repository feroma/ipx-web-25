...
const {changeMenuStatus, menuOpen, currentSectionId} = useAppState()
    ...
    <div class="container">
      <div class="row">
        <div class="col d-flex justify-content-between">
          ...
          <div class="header_menu" :class="menuOpen?'opened':'closed'">
             <SiteHeaderMenu :sections="sections"/>
          </div>
          <div class="header_icon" :class="menuOpen?'closed':'opened'">
            <svg @click.prevent="changeMenuStatus(true)" width="90" height="48" viewBox="0 0 90 48" fill="none" xmlns="http://www.w3.org/2000/svg">
